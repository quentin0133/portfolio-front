  ...
  projects: Project[] = [
    {
      title: "A",
      status: "Terminé",
      summary: "Dans un monde où le temps est une ressource tangible et monnayable, Liora, une horlogère de génie, découvre une ancienne montre capable de manipuler le flux temporel. Alors qu’elle cherche à comprendre son fonctionnement, elle attire l’attention du mystérieux Consortium des Veilleurs, une organisation qui contrôle secrètement l’économie du temps. Liora se retrouve rapidement traquée, accusée de perturber l'équilibre fragile qui maintient les riches éternellement jeunes et les pauvres à court de secondes.\n" +
        "\n" +
